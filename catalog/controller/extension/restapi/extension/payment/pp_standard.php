...
class ControllerExtensionRestapiExtensionPaymentPPStandard extends Controller {
	public function index() {
		...
		if ($order_info) {
			...
			$data['return'] = $this->url->link('extension/restapi/checkout/success');
			$data['notify_url'] = $this->url->link('extension/restapi/extension/payment/pp_standard/callback', '', true);
			$data['cancel_return'] = $this->url->link('extension/restapi/checkout/checkout', '', true);
