...
class ControllerExtensionRestapiAccountForgotten extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$message .= $this->url->link('extension/restapi/account/reset', 'code=' . $code, true) . "\n\n";
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/account/forgotten', '', true)
		);
		...
		$data['action'] = $this->url->link('extension/restapi/account/forgotten', '', true);
